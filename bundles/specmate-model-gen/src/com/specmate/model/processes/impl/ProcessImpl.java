 ...
 * @generated
 */
public class ProcessImpl extends CDOObjectImpl implements com.specmate.model.processes.Process {
	/**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessesPackage.PROCESS__ID:
				return getId();
			case ProcessesPackage.PROCESS__NAME:
				return getName();
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == INamed.class) {
			switch (derivedFeatureID) {
				case ProcessesPackage.PROCESS__NAME: return BasePackage.INAMED__NAME;
				default: return -1;
			}
		}
		if (baseClass == IDescribed.class) {
			switch (derivedFeatureID) {
				case ProcessesPackage.PROCESS__DESCRIPTION: return BasePackage.IDESCRIBED__DESCRIPTION;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == INamed.class) {
			switch (baseFeatureID) {
				case BasePackage.INAMED__NAME: return ProcessesPackage.PROCESS__NAME;
				default: return -1;
			}
		}
		if (baseClass == IDescribed.class) {
