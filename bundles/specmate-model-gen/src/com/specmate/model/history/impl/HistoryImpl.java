 ...
 * </p>
 * <ul>
 *   <li>{@link com.specmate.model.history.impl.HistoryImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HistoryImpl extends CDOObjectImpl implements History {
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HistoryPackage.HISTORY__ENTRIES:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case HistoryPackage.HISTORY__ENTRIES:
				getEntries().clear();
				getEntries().addAll((Collection<? extends HistoryEntry>)newValue);
				return;
		}
