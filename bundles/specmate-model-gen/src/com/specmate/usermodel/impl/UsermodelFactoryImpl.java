 ...
 * @generated
 */
public class UsermodelFactoryImpl extends EFactoryImpl implements UsermodelFactory {
	/**
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case UsermodelPackage.USER: return (EObject)createUser();
			case UsermodelPackage.USER_SESSION: return (EObject)createUserSession();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case UsermodelPackage.ACCESS_RIGHTS:
	 ...
	 */
	@Deprecated
	public static UsermodelPackage getPackage() {
		return UsermodelPackage.eINSTANCE;
	}
