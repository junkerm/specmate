...
//		INLPService nlpService = getNLPService();
//		JCas result = nlpService.processText("If the tool detects an error then it shows a warning window.");
...
//				new ExactlyOneConsumer(new AndMatcher(
//						new ConstituentTypeMatcher("SBAR"),
//						new FirstLeafMatcher(new CoveredTextMatcher("If")))
//				),
//				new ZeroOrMoreConsumer(new AnyMatcher(), "effect")
//				)));
...
//		Assert.assertEquals("it shows a warning window .", effect);
//		
//	}
