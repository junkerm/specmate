...
public class ModelGenerationTestEn extends ModelGenerationTestBase {
	...
	/**@Test public void testModelGenerationEN43_pattern11() {String text = "The error occurs so that Specmate crashes."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "The error", "Occurs", NodeType.AND);CEGNode node2 = createNode(model, "Specmate", "Crashes", NodeType.AND);createConnection(model, node1, node2, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	/**@Test public void testModelGenerationEN44_pattern12_1() {String text = "The user clicks the link in order that Specmate displays the model."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "The user", "Clicks the link", NodeType.AND);CEGNode node2 = createNode(model, "Specmate", "Displays the model", NodeType.AND);createConnection(model, node1, node2, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	/**@Test public void testModelGenerationEN45_pattern12_2() {String text = "In order that Specmate opens the model, the user must click the link."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "The user", "Must click the link", NodeType.AND);CEGNode node2 = createNode(model, "Specmate", "Opens the model", NodeType.AND);createConnection(model, node1, node2, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	@Test
	...
	/**@Test public void testModelGenerationEN50_pattern15_1() {String text = "Specmate loads the model, in the case that the user presses the button."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "The user", "Presses the button", NodeType.AND);CEGNode node2 = createNode(model, "Specmate", "Loads the model", NodeType.AND);createConnection(model, node1, node2, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	/**@Test public void testModelGenerationEN51_pattern15_2() {String text = "In the case that the user presses the button, Specmate loads the model."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "The user", "Presses the button", NodeType.AND);CEGNode node2 = createNode(model, "Specmate", "Loads the model", NodeType.AND);createConnection(model, node1, node2, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	/**@Test public void testModelGenerationEN52_pattern16_1() {String text = "Specmate loads the model on condition that the user presses the button."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "Specmate", "Loads the model", NodeType.AND);CEGNode node2 = createNode(model, "The user", "Presses the button", NodeType.AND);createConnection(model, node2, node1, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	/**@Test public void testModelGenerationEN53_pattern16_2() {String text = "On condition that the user presses the button, Specmate loads the model."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "The user", "Presses the button", NodeType.AND);CEGNode node2 = createNode(model, "Specmate", "Loads the model", NodeType.AND);createConnection(model, node1, node2, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	@Test
	...
	/**@Test public void testModelGenerationEN56_pattern5_3() {String text = "The tool detects an error as a result the tool beeps."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "The tool", "Detects an error", NodeType.AND);CEGNode node2 = createNode(model, "The tool", "Beeps", NodeType.AND);createConnection(model, node1, node2, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
	/**@Test public void testModelGenerationEN58_pattern2_4_and() {String text = "When there is snow on the tree and the wind is blowing and the sun is not shining and the temperature is very low, the branches break."; RequirementsFactory f = RequirementsFactory.eINSTANCE; CEGModel model = f.createCEGModel();CEGNode node1 = createNode(model, "There", "Is snow on the tree", NodeType.AND);CEGNode node2 = createNode(model, "The wind", "Is blowing", NodeType.AND);CEGNode node3 = createNode(model, "The sun", "Is shining", NodeType.AND);CEGNode node4 = createNode(model, "The temperature", "Is very low ", NodeType.AND);CEGNode node5 = createNode(model, "The branches", "Break", NodeType.AND);createConnection(model, node2, node1, false);JSONArray generated = generateCEGWithModelRequirementsText(text); checkResultingModel(generated, model); }*/
