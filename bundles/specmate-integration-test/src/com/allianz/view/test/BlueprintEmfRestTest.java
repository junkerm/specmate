...
//
//
// public class BlueprintEmfRestTest extends EmfRestTest {
//
// //private static final String REFINEMENTS_NAME =
// BlueprintPackage.Literals.ACTION__REFINEMENTS.getName();
// private static final String BP_VIEW_KEY = "com.allianz.views.blueprint";
//
// /* package */ static final String BASEMODEL_NODE_NAME =
// BasemodelPackage.Literals.BASE_MODEL_NODE.getName();
// /* package */ static final String VARIANTS_NAME =
// BlueprintPackage.Literals.BLUEPRINT__VARIANTS.getName();
// /* package */ static final String SUCC_NAME =
// BlueprintPackage.Literals.BLUE_PRINT_ELEMENT_BASE__SUCCESSORS.getName();
// /* package */ static final String PRED_NAME =
// BlueprintPackage.Literals.BLUE_PRINT_ELEMENT_BASE__PREDECESSORS.getName();
//
//
...
// }
//
// /* package */ static Action getTestAction(boolean optional, String
// actionName, int myYCounter) {
// return getTestAction(optional, "Action " + (counter++), "Action Description"
// + (counter++), myYCounter);
// }
//
// /* package */ static Action getTestAction(boolean optional, String
// actionName, String description, int myYCounter) {
...
// {
//// BlueprintToTestRefinement refinement =
// TestFactory.eINSTANCE.createBlueprintToTestRefinement();
...
//
//
// /* package */ static String createAndPostBlueprintToUrl(String url) throws
// SpecmateException {
// return createAndPostBlueprintToUrl(url, "Name " + (counter++));
// }
//
//
// /* package */ static String createAndPostBlueprintToUrl(String url, String
// blueprintName) throws SpecmateException {
// Blueprint blueprint = getTestBlueprint(blueprintName);
// return postBlueprintToUrl(url, blueprint);
// }
//
//
// /* package */ static String postBlueprintToUrl(String url, Blueprint
// blueprint) throws SpecmateException {
// String blueprintUrl = postAndVerify(blueprint, url, CONTENTS_NAME);
// return blueprintUrl;
// }
//
// /* package */ static String createAndPostActionToUrl(String url, boolean
// optional) throws SpecmateException {
// Action action = getTestAction(optional);
// String actionUrl = postAndVerify(action,url, CONTENTS_NAME);
// return actionUrl;
// }
//
// /* package */ static String postActionToUrl(String url, Action action) throws
// SpecmateException {
// String actionUrl = postAndVerify(action,url, CONTENTS_NAME);
// return actionUrl;
// }
//
//// /*package */ static String createAndPostBlueprintToTestRefinement(String
// actionUrl) throws SpecmateException {
//// BlueprintToTestRefinement refinement = getTestBlueprintToTestRefinement();
//// String refinementUrl = postAndVerify(refinement, actionUrl,
// REFINEMENTS_NAME);
//// return refinementUrl;
//// }
//
//
// /* package */ static String createAndPostDecisionToUrl(String url) throws
// SpecmateException {
// Decision decision = getTestDecision();
// return postDecisionToUrl(url, decision);
// }
//
// /* package */ static String postDecisionToUrl(String url, Decision decision)
// throws SpecmateException {
// String decisionUrl = postAndVerify(decision,url, CONTENTS_NAME);
// return decisionUrl;
// }
//
// /* package */ static String createAndPostConditionToUrl(String url) throws
// SpecmateException {
// Condition condition = getTestCondition();
// return postConditionToUrl(url, condition);
// }
//
// /* package */ static String postConditionToUrl(String url, Condition
// condition) throws SpecmateException {
// String conditionUrl = postAndVerify(condition,url, CONTENTS_NAME);
// return conditionUrl;
// }
//
// /* package */ static String createAndPostVariantToUrl(String url) throws
// SpecmateException {
// Variant variant = getTestVariant();
// return postVariantToUrl(url, variant);
// }
//
// /* package */ static String postVariantToUrl(String url, Variant variant)
// throws SpecmateException {
...
//
//
// /* package */ static void connectAndDisconnectSuccActions(String folderUrl)
// throws SpecmateException {
...
// putAndVerify(retrieved1,actionUrl1,expectEventWithValue(EChangeKind.ADD.toString(),
// proxy,false));
//
...
//
//
// /* package */ static void connectAndDisconnectPredActions(String folderUrl)
// throws SpecmateException {
// Action action1 = getTestAction();
// Action action2 = getTestAction();
// String actionUrl1=postAndVerify(action1,folderUrl, CONTENTS_NAME);
...
// }
//
// /* package */ static void connectAndDisconnectDecisionToAction(String
// blueprintUrl) throws SpecmateException {
// Action action1 = getTestAction();
// Decision decision = getTestDecision();
...
// putAndVerify(retrievedAction,actionUrl,expectEventWithValue(EChangeKind.ADD.toString(),
// proxy,false));
//
...
// }
//
// /* package */ static void connectAndDisconnectConditionToDecision(String
// blueprintUrl) throws SpecmateException {
// Decision decision = getTestDecision();
// Condition condition = getTestCondition();
// String decisionUrl=postAndVerify(decision,blueprintUrl, CONTENTS_NAME);
...
// putAndVerify(retrievedDecision,decisionUrl,expectEventWithValue(EChangeKind.ADD.toString(),
// proxy,false));
//
...
//
//
// /* package */ static String createAndPostBlueprintToFolder() throws
// SpecmateException {
...
//
//
// /* package */ static String postBlueprintToFolder(Blueprint blueprint) throws
// SpecmateException {
// String folderUri = createAndPostFolderToProject();
...
//
//
// /*package*/ static String createAndPostActionToBlueprint(boolean optional)
// throws SpecmateException {
// String blueprintUri = createAndPostBlueprintToFolder();
// return createAndPostActionToUrl(blueprintUri,optional);
// }
//
// /*package*/ static String createAndPostActionToBlueprint(Action action)
// throws SpecmateException {
// String blueprintUri = createAndPostBlueprintToFolder();
// return postActionToUrl(blueprintUri,action);
// }
//
// /* package */ static String createAndPostDecisionToBlueprint() throws
// SpecmateException {
// String blueprintUri = createAndPostBlueprintToFolder();
// return createAndPostDecisionToUrl(blueprintUri);
// }
//
// /* package */ static String postDecisionToBlueprint(Decision decision) throws
// SpecmateException {
// String blueprintUri = createAndPostBlueprintToFolder();
// return postDecisionToUrl(blueprintUri, decision);
// }
//
// /* package */ static String createAndPostConditionToBlueprint() throws
// SpecmateException {
// String blueprintUri = createAndPostBlueprintToFolder();
// return createAndPostConditionToUrl(blueprintUri);
// }
//
// /* package */ static String postConditionToBlueprint(Condition condition)
// throws SpecmateException {
// String blueprintUri = createAndPostBlueprintToFolder();
// return postConditionToUrl(blueprintUri,condition);
// }
//
// /* package */ static String createAndPostVariantToBlueprint() throws
// SpecmateException {
// String blueprintUrl = createAndPostBlueprintToFolder();
// return createAndPostVariantToUrl(blueprintUrl);
// }
//
// /* package */ static String postVariantToBlueprint(Variant variant) throws
// SpecmateException {
// String blueprintUrl = createAndPostBlueprintToFolder();
...
// putAndVerify(blueprintUpdate, url,
...
// putAndVerify(update, url, expectEventWithUrl(EChangeKind.SET.toString(),
// url));
// }
//
// @Test
...
// putAndVerify(retrievedAction,actionUrl1,expectEventWithValue(EChangeKind.ADD.toString(),
// proxy,false));
////
