...
public class AllianzTestEmfResttest extends EmfRestTestBase {

	/*package*/ static final String PRECONDITIION_NAME = TestPackage.Literals.TEST_SPECIFICATION__PRECONDITION.getName();
	/*package*/ static final String TESTPROCEDURE_NAME = TestPackage.Literals.TEST_SPECIFICATION__TESTPROCEDURE.getName();
	private static final String VIEW_KEY = "com.allianz.views.testview";
	
	
	/*package*/ static String createAndPostTestSpecificationToProject() throws SpecmateException  {		
		String projectUrl = createAndPostProject();		
		return createAndPostTestSpecificationToUrl(projectUrl);
	}
	
	/* package */ static String createAndPostTestSpecificationToUrl(String url) throws SpecmateException {
		TestSpecification test = getTestSpecification();
		return postAndVerify(test, url, CONTENTS_NAME);

	}
	
	/*package*/ static String createAndPostAllianzTestFolderToProject() throws SpecmateException {
		String projectUrl = createAndPostProject();
		return createAndPostAllianzTestFolderToUrl(projectUrl);
	}
	

	/* package */ static String createAndPostPreconditionToTestSpecification() throws SpecmateException {
	...
	/*package*/ static String createAndPostTestProcedureToTestSpecification() throws SpecmateException {
		String specUrl = createAndPostTestSpecificationToProject();	
		Slice slice = createTestSlice();
		return postAndVerify(slice,specUrl,TESTPROCEDURE_NAME);
	}
	
	/*package*/ static String createAndPostAllianzTestFolderToUrl(String url) throws SpecmateException {
	...
	/*package*/ static TestSpecification getTestSpecification(String name, String description) {
