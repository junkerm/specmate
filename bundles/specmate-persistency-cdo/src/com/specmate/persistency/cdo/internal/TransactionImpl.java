...
public class TransactionImpl extends ViewImpl implements ITransaction {
	...
	private <T> void commit(T object) throws SpecmateException {
		...
		try {
			...
			try {
				...
				throw (new SpecmateInternalException(ErrorCode.PERSISTENCY, "Error while preparing commit, transaction rolled back", s));
			}
	...
	public void rollback() throws SpecmateException {
		try {
			...
			throw new SpecmateInternalException(ErrorCode.PERSISTENCY, "Error on transaction rollback", e);
		}
	}
