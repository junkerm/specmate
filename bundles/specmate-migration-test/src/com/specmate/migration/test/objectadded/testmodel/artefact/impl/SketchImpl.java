 ...
 * </p>
 * <ul>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#isTested <em>Tested</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getContents <em>Contents</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getByteVar1 <em>Byte Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getByteVar2 <em>Byte Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getByteVar3 <em>Byte Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getByteVar4 <em>Byte Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getByteVar5 <em>Byte Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getShortVar1 <em>Short Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getShortVar2 <em>Short Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getShortVar3 <em>Short Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getShortVar4 <em>Short Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getShortVar5 <em>Short Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getIntVar1 <em>Int Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getIntVar2 <em>Int Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getIntVar3 <em>Int Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getIntVar4 <em>Int Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getIntVar5 <em>Int Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getCharVar1 <em>Char Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getCharVar2 <em>Char Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getCharVar3 <em>Char Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getCharVar4 <em>Char Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getCharVar5 <em>Char Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getLongVar1 <em>Long Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getLongVar2 <em>Long Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getLongVar3 <em>Long Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getLongVar4 <em>Long Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getLongVar5 <em>Long Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getFloatVar1 <em>Float Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getFloatVar2 <em>Float Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getFloatVar3 <em>Float Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getFloatVar4 <em>Float Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getFloatVar5 <em>Float Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getDoubleVar1 <em>Double Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getDoubleVar2 <em>Double Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getDoubleVar3 <em>Double Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getDoubleVar4 <em>Double Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getDoubleVar5 <em>Double Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#isBooleanVar1 <em>Boolean Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#isBooleanVar2 <em>Boolean Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#isBooleanVar3 <em>Boolean Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#isBooleanVar4 <em>Boolean Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#isBooleanVar5 <em>Boolean Var5</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getStringVar1 <em>String Var1</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getStringVar2 <em>String Var2</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getStringVar3 <em>String Var3</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getStringVar4 <em>String Var4</em>}</li>
 *   <li>{@link com.specmate.migration.test.objectadded.testmodel.artefact.impl.SketchImpl#getStringVar5 <em>String Var5</em>}</li>
 * </ul>
 *
 * @generated
 */
