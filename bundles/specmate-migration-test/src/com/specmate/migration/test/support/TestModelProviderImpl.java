...
public class TestModelProviderImpl implements IPackageProvider {
	...
	public Collection<? extends EPackage> getPackages() {
		if (modelName == null
				|| modelName.equals(com.specmate.migration.test.baseline.testmodel.base.BasePackage.class.getName())) {
			return getBasemodelPackages();
		} else if (modelName
				.equals(com.specmate.migration.test.attributeadded.testmodel.base.BasePackage.class.getName())) {
			return getAttributeAddedPackages();
		} else if (modelName.equals(
				com.specmate.migration.test.severalattributesadded.testmodel.base.BasePackage.class.getName())) {
			return getSeveralAttributesAddedPackages();
		} else if (modelName
				.equals(com.specmate.migration.test.objectadded.testmodel.base.BasePackage.class.getName())) {
			return getObjectAddedPackages();
		} else if (modelName
				.equals(com.specmate.migration.test.attributerenamed.testmodel.base.BasePackage.class.getName())) {
			return getAttributeRenamedPackages();
		} else if (modelName
				.equals(com.specmate.migration.test.changedtypes.testmodel.base.BasePackage.class.getName())) {
			return getChangedTypesPackages();
		} else if (modelName
				.equals(com.specmate.migration.test.onlymetachange.testmodel.base.BasePackage.class.getName())) {
			return getOnlyMetaChangePackages();
		}
	...
	private Collection<? extends EPackage> getOnlyMetaChangePackages() {
		return Arrays.asList(com.specmate.migration.test.onlymetachange.testmodel.base.BasePackage.eINSTANCE,
				com.specmate.migration.test.onlymetachange.testmodel.artefact.ArtefactPackage.eINSTANCE);
	}
}
