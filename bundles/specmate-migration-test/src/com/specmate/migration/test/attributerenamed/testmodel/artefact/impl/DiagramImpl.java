 ...
 * </p>
 * <ul>
 *   <li>{@link com.specmate.migration.test.attributerenamed.testmodel.artefact.impl.DiagramImpl#isIstested <em>Istested</em>}</li>
 *   <li>{@link com.specmate.migration.test.attributerenamed.testmodel.artefact.impl.DiagramImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.specmate.migration.test.attributerenamed.testmodel.artefact.impl.DiagramImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagramImpl extends MinimalEObjectImpl.Container implements Diagram {
	...
	public boolean isIstested() {
		return (Boolean)eDynamicGet(ArtefactPackage.DIAGRAM__ISTESTED, BasePackage.Literals.ITESTABLE__ISTESTED, true, true);
	}
	...
	public void setIstested(boolean newIstested) {
		eDynamicSet(ArtefactPackage.DIAGRAM__ISTESTED, BasePackage.Literals.ITESTABLE__ISTESTED, newIstested);
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ArtefactPackage.DIAGRAM__ISTESTED:
				return isIstested();
