/**
 */
package com.specmate.migration.test.attributerenamed.testmodel.base.impl;

import com.specmate.migration.test.attributerenamed.testmodel.artefact.ArtefactPackage;

import com.specmate.migration.test.attributerenamed.testmodel.artefact.impl.ArtefactPackageImpl;

import com.specmate.migration.test.attributerenamed.testmodel.base.BaseFactory;
...
public class BasePackageImpl extends EPackageImpl implements BasePackage {
	 ...
	 * @see com.specmate.migration.test.attributerenamed.testmodel.base.BasePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getITestable_Istested() {
	...
	public void createPackageContents() {
		...
		createEAttribute(iTestableEClass, ITESTABLE__ISTESTED);
	...
	public void initializePackageContents() {
		...
		initEClass(iidEClass, com.specmate.migration.test.attributerenamed.testmodel.base.IID.class, "IID", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getIID_Id(), ecorePackage.getEString(), "id", null, 0, 1, com.specmate.migration.test.attributerenamed.testmodel.base.IID.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getITestable_Istested(), ecorePackage.getEBoolean(), "istested", null, 0, 1, ITestable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
