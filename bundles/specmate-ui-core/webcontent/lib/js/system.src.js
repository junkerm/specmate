            ...
            function execute(req, exports, module) {
                ...
                if (requireIndex !== -1) {
                    var contextualRequire = function(names, callback, errback) {
                        if (typeof names === 'string' && typeof callback !== 'function')
                            return req(names);
                        return require.call(loader, names, callback, errback, module.id.toString());
                    };
                    contextualRequire.toUrl = function(name) {
                        return loader.normalizeSync(name, module.id.toString());
                    };
                ...
                switch (metadata.load.format) {
                    ...
                    case 'cjs':
                        ...
                        loader.registerDynamic(deps, true, function(require, exports, module) {
                            require.resolve = function(key) {
                                return requireResolve.call(loader, key, module.id.toString());
                            };
                            ...
                            var pathVars = getPathVars(module.id.toString());
                            var __cjsWrapper = {
                                exports: exports,
                    ...
                    case 'global':
                        ...
                        loader.registerDynamic(deps, false, function(require, exports, module) {
                            ...
                            var retrieveGlobal = prepareGlobal(module.id.toString(), exportName, globals, metadata.load.encapsulateGlobal);
