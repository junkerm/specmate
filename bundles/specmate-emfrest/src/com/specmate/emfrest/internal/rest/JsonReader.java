...
public class JsonReader implements MessageBodyReader<EObject> {
	...
	/** {@inheritDoc} */
	@Override
	public EObject readFrom(Class<EObject> clazz, Type type,
			Annotation[] annotations, MediaType mediaType,
		...
		try {
			...
			EMFJsonDeserializer emfJsonDeserializer = new EMFJsonDeserializer(
					resolver, transaction.getResource());
			deserializedEObject = emfJsonDeserializer
					.deserializeEObject(jsonObject);
		} catch (Exception e) {
